...
int g_snake_column = 2; //horizontal position of snake (when used as index, position 3 (0,1,2,3))
int g_snake_row = 2; //vertical position of snake (same as above with index)
